resource "aws_iam_role_policy_attachment" "lambda_policy_s3_get_object" {
  policy_arn = aws_iam_policy.lambda_policy_s3_get_object.arn
  role       = aws_iam_role.lambda_s3_get_object.name
}

resource "aws_iam_role_policy_attachment" "lambda_policy_s3_get_object_invoke" {
